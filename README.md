# Set of tutorials
1. **Super Cloud @ MIT Tutorial**  - How to run code on a supercomputer in parallel. The instructions below are specific to Supercloud but the script used (<code> SimpleParallelScript.ipynb </code>) could be used on any supercomputer.
